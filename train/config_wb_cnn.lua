...
config.model[1] = {module = "nn.SpatialConvolution", nInputPlane = 4, nOutputPlane= 128, kW = 15, kH=5, dW = 15, dH = 1}
config.model[2] = {module = "nn.ReLU"}
config.model[3] = {module = "nn.SpatialMaxPooling", kW = 3, kH = 1, dW=3, dH=1}

config.model[4] = {module = "nn.Reshape", dimension1 = 2816, dimension2 = nil, dimension3 = nil }
config.model[5] = {module = "nn.Linear", inputSize = 2816, outputSize = 1024}
config.model[6] = {module = "nn.ReLU"}
config.model[7] = {module = "nn.Dropout", p = 0.5}
config.model[8] = {module = "nn.Linear", inputSize = 1024, outputSize = 5}
