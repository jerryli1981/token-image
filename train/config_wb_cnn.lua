...
config.model[1] = {module = "nn.SpatialConvolution", nInputPlane = 4, nOutputPlane= 128, kW = 2, kH=2, dW = 1, dH = 1}
...
config.model[10] = {module = "nn.SpatialConvolution", nInputPlane = 128, nOutputPlane= 128, kW = 5, kH=1, dW = 1, dH = 1}
config.model[11] = {module = "nn.ReLU"}
config.model[12] = {module = "nn.SpatialMaxPooling", kW = 3, kH = 1, dW=3, dH=1}


config.model[13] = {module = "nn.Reshape", dimension1 = 128*9, dimension2 = nil, dimension3 = nil }

config.model[14] = {module = "nn.Linear", inputSize = 128*9, outputSize = 1024}
config.model[15] = {module = "nn.ReLU"}
config.model[16] = {module = "nn.Dropout", p = 0.5}
config.model[17] = {module = "nn.Linear", inputSize = 1024, outputSize = 5}
