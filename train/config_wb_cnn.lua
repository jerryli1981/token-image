...
config.model[1] = {module = "nn.SpatialConvolution", nInputPlane = 4, nOutputPlane= 64, kW = 20, kH=5, dW = 5, dH = 1}
config.model[2] = {module = "nn.ReLU"}
config.model[3] = {module = "nn.SpatialMaxPooling", kW = 4, kH = 1, dW=1, dH=1}

config.model[4] = {module = "nn.SpatialConvolution", nInputPlane = 64, nOutputPlane= 64, kW = 20, kH=1, dW = 5, dH = 1}
config.model[5] = {module = "nn.ReLU"}
config.model[6] = {module = "nn.SpatialMaxPooling", kW = 4, kH = 1, dW=1, dH=1}

config.model[7] = {module = "nn.SpatialConvolution", nInputPlane = 64, nOutputPlane= 64, kW = 4, kH=1, dW = 1, dH = 1}
config.model[8] = {module = "nn.ReLU"}

config.model[9] = {module = "nn.SpatialConvolution", nInputPlane = 64, nOutputPlane= 64, kW = 4, kH=1, dW = 1, dH = 1}
config.model[10] = {module = "nn.ReLU"}

config.model[11] = {module = "nn.SpatialConvolution", nInputPlane = 64, nOutputPlane= 64, kW = 4, kH=1, dW = 1, dH = 1}
config.model[12] = {module = "nn.ReLU"}

config.model[13] = {module = "nn.SpatialConvolution", nInputPlane = 64, nOutputPlane= 64, kW = 4, kH=1, dW = 1, dH = 1}
