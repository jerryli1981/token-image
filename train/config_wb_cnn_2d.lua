...
--]]
-- 34 x 256
config.model[7] = {module = "nn.Reshape", dimension1 = 2200, dimension2 = nil, dimension3 = nil }
-- 8704
config.model[8] = {module = "nn.Linear", inputSize = 2200, outputSize = 1024}
config.model[9] = {module = "nn.Threshold"}
config.model[10] = {module = "nn.Dropout", p = 0.5}
-- 1024
config.model[11] = {module = "nn.Linear", inputSize = 1024, outputSize = 1024}
config.model[12] = {module = "nn.Threshold"}
