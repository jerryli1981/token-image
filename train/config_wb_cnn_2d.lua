...
config.model[1] = {module = "nn.SpatialConvolution", nInputPlane = 1, nOutputPlane= 100, kW = 10, kH=5}
--100x1x491
...
config.model[4] = {module = "nn.SpatialConvolution", nInputPlane = 100, nOutputPlane= 100, kW = 10, kH=1}
config.model[5] = {module = "nn.Tanh"}
...
--]]
-- 34 x 256
config.model[7] = {module = "nn.Reshape", dimension1 = 1000, dimension2 = nil, dimension3 = nil }
-- 8704
config.model[8] = {module = "nn.Linear", inputSize = 1000, outputSize = 512}
...
-- 1024
config.model[14] = {module = "nn.Linear", inputSize = 512, outputSize = 5}
