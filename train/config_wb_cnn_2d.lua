...
config.model[7] = {module = "nn.SpatialConvolution", nInputPlane = 50, nOutputPlane= 50, kW = 8, kH=1}
...
--]]
-- 34 x 256
config.model[11] = {module = "nn.Reshape", dimension1 = 4050, dimension2 = nil, dimension3 = nil }
-- 8704
config.model[12] = {module = "nn.Linear", inputSize = 4050, outputSize = 1024}
config.model[13] = {module = "nn.Threshold"}
config.model[14] = {module = "nn.Dropout", p = 0.5}

-- 1024
config.model[15] = {module = "nn.Linear", inputSize = 1024, outputSize = 5}
config.model[16] = {module = "nn.LogSoftMax"}
