...
-- Execute testing for a batch step
function Test:run_wb_3d(logfunc)
   -- Initializing the errors and losses
   self.e = 0
   self.l = 0
   self.n = 0
   ...
   -- Start the loop
   self.clock = sys.clock()
   for batch,labels,n in self.data:iterator_wb_3d() do
...
-- Execute testing for a batch step
function Test:run_wb_2d_cnn(logfunc)
   -- Initializing the errors and losses
   self.e = 0
   self.l = 0
   self.n = 0
   ...
   -- Start the loop
   self.clock = sys.clock()
   for batch,labels,n in self.data:iterator_wb_2d_cnn() do
      self.batch = self.batch or batch:contiguous():type(self.model:type())
      self.labels = self.labels or labels:type(self.model:type())
      self.batch:copy(batch:contiguous())
      self.labels:copy(labels)
...
-- Execute testing for a batch step
function Test:run_wb_2d_lstm(logfunc)
   -- Initializing the errors and losses
   self.e = 0
   self.l = 0
   self.n = 0
   ...
   -- Start the loop
   self.clock = sys.clock()
   for batch,labels,n in self.data:iterator_wb_2d_lstm() do
      self.batch = self.batch or batch:contiguous():type(self.model:type())
      self.labels = self.labels or labels:type(self.model:type())
      self.batch:copy(batch:contiguous())
      self.labels:copy(labels)
